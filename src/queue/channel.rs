...
//acabei de pergutar do chat se era isso mesmo e ele me disse que o channel não pode existir sem um tipo, posso dizer que é um box dyn mas estpu sendo explicito aí, e nessa nossa função o rust consegue inferir o tipo através da nossa assinatura 